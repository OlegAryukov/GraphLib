...
public class UnDirectionalGraphImpl<T, D> implements Graph<T, D> {
    ...
    private boolean hasPathTo(D label) {
        Vertex dest = vertexesMap.get(label);
        return dest != null && dest.isWasVisited();
    }
}
